...
apigClientFactory.newClient = function (config) {
    ...
    // TODO: API Gateway Invoke URL
    var endpoint = 'https://2zdtz07ge1.execute-api.ap-northeast-1.amazonaws.com/demo';
    ...
    apigClient.commentsGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['track'], ['body']);
        ...
        var commentsGetRequest = {
            ...
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['track']),
            body: body
        };
